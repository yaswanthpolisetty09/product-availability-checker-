...
urlpatterns = [
    ...
    path('updateind/',views.updaterec),
    path('seller/<str:sid>/<int:flag>/',views.sell,name='sellerp'),
    path('buyer/',v2.buy),]+static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)
